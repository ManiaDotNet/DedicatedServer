...
{
    public sealed class GuestListInfoStruct : BaseStruct<GuestListInfoStruct>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the blacklisted login.
        /// </summary>
        public string Login
        {
        ...
        public override GuestListInfoStruct ParseXml(XElement xElement)
        {
            checkName(xElement);
