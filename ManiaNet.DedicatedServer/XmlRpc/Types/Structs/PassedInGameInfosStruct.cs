...
namespace ManiaNet.DedicatedServer.XmlRpc.Types.Structs
{
    ...
    public sealed class PassedInGameInfosStruct : BaseStruct<PassedInGameInfosStruct>
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ManiaNet.DedicatedServer.XmlRpc.Types.Structs.PassedInGameInfoStruct"/> without content (for parsing from Xml).
        /// </summary>
        public PassedInGameInfosStruct()
        { }

        /// <summary>
        /// Creates a new instance of the <see cref="ManiaNet.DedicatedServer.XmlRpc.Types.Structs.PassedInGameInfoStruct"/> from the given game infos.
        /// </summary>
