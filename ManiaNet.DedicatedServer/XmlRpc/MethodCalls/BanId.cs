...
namespace ManiaNet.DedicatedServer.XmlRpc.MethodCalls
{
    ...
    /// </summary>
    public sealed class BanId : MethodCall<XmlRpcInt, int, XmlRpcString, string, XmlRpcBoolean, bool>
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ManiaNet.DedicatedServer.XmlRpc.MethodCalls.BanId"/> class with the given Id and optional message.
        /// </summary>
