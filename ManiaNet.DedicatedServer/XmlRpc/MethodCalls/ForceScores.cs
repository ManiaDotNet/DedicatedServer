...
namespace ManiaNet.DedicatedServer.XmlRpc.MethodCalls
{
    ...
    /// </summary>
    public sealed class ForceScores : MethodCall<XmlRpcArray<XmlRpcStruct<ForceScoreStruct>, ForceScoreStruct>, XmlRpcStruct<ForceScoreStruct>[], XmlRpcBoolean, bool, XmlRpcBoolean, bool>
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ManiaNet.DedicatedServer.XmlRpc.MethodCalls.ForceScores"/> class with the given scores and whether to update them silently or not.
        /// </summary>
