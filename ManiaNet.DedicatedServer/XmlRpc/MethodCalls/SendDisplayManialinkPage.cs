...
namespace ManiaNet.DedicatedServer.XmlRpc.MethodCalls
{
    ...
    /// </summary>
    public sealed class SendDisplayManialinkPage : MethodCall<XmlRpcString, string, XmlRpcInt, int, XmlRpcBoolean, bool, XmlRpcBoolean, bool>
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ManiaNet.DedicatedServer.XmlRpc.MethodCalls.SendDisplayManialinkPage"/> class with the given page and settings.
        /// </summary>
