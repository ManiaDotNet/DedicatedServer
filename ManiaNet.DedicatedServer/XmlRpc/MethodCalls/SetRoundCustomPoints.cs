...
namespace ManiaNet.DedicatedServer.XmlRpc.MethodCalls
{
    ...
    /// </summary>
    public sealed class SetRoundCustomPoints : MethodCall<XmlRpcArray<XmlRpcInt, int>, XmlRpcInt[], XmlRpcBoolean, bool, XmlRpcBoolean, bool>
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ManiaNet.DedicatedServer.XmlRpc.MethodCalls.SetRoundCustomPoints"/> class with the given points.
        /// </summary>
