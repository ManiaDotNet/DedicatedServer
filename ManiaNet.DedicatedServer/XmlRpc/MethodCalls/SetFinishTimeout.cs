...
namespace ManiaNet.DedicatedServer.XmlRpc.MethodCalls
{
    ...
    /// </summary>
    public sealed class SetFinishTimeout : MethodCall<XmlRpcInt, int, XmlRpcBoolean, bool>
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ManiaNet.DedicatedServer.XmlRpc.MethodCalls.SetFinishTimeout"/> class for the given timeout.
        /// </summary>
