...
namespace ManiaNet.DedicatedServer.XmlRpc.Methods
{
    ...
    /// </summary>
    [UsedImplicitly]
    public sealed class Ban : XmlRpcMethodCall<XmlRpcString, string, XmlRpcString, string, XmlRpcBoolean, bool>
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ManiaNet.DedicatedServer.XmlRpc.Methods.Ban"/> class with the given login and optional message.
        /// </summary>
        /// <param name="login">The login that will be kicked.</param>
        /// <param name="message">The optional ban message.</param>
        public Ban([NotNull] string login, [CanBeNull] string message = null)
            : base(login, message)
        { }
